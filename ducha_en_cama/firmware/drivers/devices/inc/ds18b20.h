...
/*enviar comandos o señales de control al sensor: */
void ds18b20_write(char bit);
/*Es útil para recibir datos o respuestas del sensor: */
unsigned char ds18b20_read(void);
/*Puede utilizarse para enviar datos de configuración o solicitudes de lectura al sensor: */
void ds18b20_write_byte(char data);
/*Se utiliza para recibir los datos de temperatura que el sensor ha convertido.*/
unsigned char ds18b20_read_byte(void);
/*Se utiliza para iniciar la comunicación con el sensor*/
unsigned char ds18b20_reset(void);

/*ajusto la resolucion del sensor*/
bool ds18b20_setResolution(const DeviceAddress tempSensorAddresses[], int numAddresses, uint8_t newResolution);
/*comrpueba si sensor esta conectado*/
...
/*devuelve valor temperatura en grados celsius: */
float ds18b20_getTempC(const DeviceAddress *deviceAddress);
/*calcula temperatura a partir de los datos del sensor: */
int16_t calculateTemperature(const DeviceAddress *deviceAddress, uint8_t* scratchPad);
/*Obtiene la temperatura del sensor sin especificar una dirección.*/
